...
var MapsLib = {
  ...
  fusionTableId:      "19zeiWc5fWmloWnn_Q5VMENAJQVSNAwBLxUWf4ahU",

  //*New Fusion Tables Requirement* API key. found at https://code.google.com/apis/console/
  //*Important* this key is for demonstration purposes. please register your own.
  googleApiKey:       "AIzaSyDSmDLtAjS3aqQihnv8UixdPryRZCHeang",
  ...
  map_centroid:       new google.maps.LatLng(30.25, -97.75), //center that your map defaults to
  locationScope:      "austin",      //geographical area appended to all address searches
  recordName:         "restaurant inspection",       //for showing number of results
  recordNamePlural:   "restaurant inspections",
  ...
  doSearch: function(location) {
    ...
    if (text_search != '')
      whereClause += " AND 'Restaurant Name' contains ignoring case '" + text_search + "'";
    $("#text_search").val("");

    var type_column = "'Score Selector'";
